...
<html lang="en">
  ...
  <body>
    <h1 class="a-h1">Log In</h1>
    <p class="a-p">Please log in to view the page that you requested.</p>
    ...
    <?php endif; ?>
    <form class="a-form" action="" method="post"><!--      2.	The <form> tag has an empty action attribute, so this form will
    ...
    <p class="a-p"><a href="/admin/">Return to JMS home</a></p><!--

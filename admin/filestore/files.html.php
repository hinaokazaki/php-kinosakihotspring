...
<html lang="en">
  ...
  <body>
    <h1 class="a-h1">PHP/MySQL File Repository</h1>

    <form  class="a-s-form" action="" method="post" enctype="multipart/form-data">
      <div>
    ...
    <p class="a-p">The following files are stored in the database:</p>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <form class="a-form-n" action="" method="get">
              <div>
